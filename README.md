...
```bash
cd "/c/Users/Antjan/projects/freeks-coach"
...
```
/auto --from idea docs/superpowers/specs/2026-06-14-freeks-coach-opdracht.md
```

`/auto` doorloopt mission-wizard → brainstorm → plan → bouw → promote → retrospect autonoom.

> Origineel ingebouwd door `/start-project` op 2026-06-14.
<!-- /LABTECH-KICKOFF -->
